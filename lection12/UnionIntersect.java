...
*/
    ...
    public static void main(String[] args) {
        ...
        LinkedHashSet<String> linkedHashSet1 = new LinkedHashSet<String>(10, 0.8f);
        LinkedHashSet<String> linkedHashSet2 = new LinkedHashSet<String>(10, 0.8f);
        LinkedHashSet<String> linkedHashSet3 = new LinkedHashSet<String>(10, 0.8f);
        ...
        LinkedHashSet unionLinkedSet = uis.union(linkedHashSet1, linkedHashSet2, linkedHashSet3);
        ...
        Set unionSet1 = uis.union(LinkedHashSet.class, linkedHashSet1, linkedHashSet2, linkedHashSet3);
        System.out.println("union as LinkedHashSet (mixed): " + unionSet1);
        Set unionSet2 = uis.union(TreeSet.class, hashSet1, linkedHashSet1, treeSet1);
        System.out.println("union TreeSet (mixed): " + unionSet2);
        Set unionSet4 = uis.union(hashSet1, linkedHashSet1, treeSet1);
        System.out.println("union (mixed): " + unionSet1);
//        System.out.println(uis.union(TreeMap.class, hashSet1, linkedHashSet1, treeSet1));     // !! супер! не пропускает!
//        System.out.println("union Set : " + unionSet);

        Set intersectSet1 = uis.intersect(hashSet1, linkedHashSet1);
        System.out.println("intersect hashSet1 & linkedHashSet1: " + intersectSet1);
        Set intersectSet2 = uis.intersect(hashSet1, treeSet1);
        System.out.println("intersect hashSet1 & treeSet1: " + intersectSet2);
        Set intersectSet3 = uis.intersect(hashSet1, linkedHashSet1, treeSet1);
